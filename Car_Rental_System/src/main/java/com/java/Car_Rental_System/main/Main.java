package com.java.Car_Rental_System.main;
...
import com.java.Car_Rental_System.dao.CustomerDao;
import com.java.Car_Rental_System.dao.VehicleDao;
import com.java.Car_Rental_System.dao.VehicleDaoImpl;
import com.java.Car_Rental_System.dao.LeaseDao;
import com.java.Car_Rental_System.dao.LeaseDaoImpl;
import com.java.Car_Rental_System.dao.PaymentDao;
import com.java.Car_Rental_System.dao.PaymentDaoImpl;
...
public class Main {
	...
	private static void searchVehicle() throws ClassNotFoundException, SQLException {
		...
		Vehicle_ID = sc.next();
		Vehicle veh = vehDao.searchByVehId(Vehicle_ID);
		if (veh!=null) {
			System.out.println(veh);
		} else {
	...
	public static void searchCustomer() throws ClassNotFoundException, SQLException {
		...
		Customer_ID = sc.next();
		Customer Cust = custDao.searchByCustId(Customer_ID);
		if (Cust!=null) {
			System.out.println(Cust);
		} else {
			System.out.println("*** Customer Record Not Found ***");
	...
	public static void ShowByCustName() throws ClassNotFoundException, SQLException {
		...
		Customer Cust = custDao.searchByCustName(Customer_Name);
		if (Cust!=null) {
			System.out.println(Cust);
		} else {
			System.out.println("*** Customer Record Not Found ***");
